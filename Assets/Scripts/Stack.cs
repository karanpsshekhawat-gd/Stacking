...
public class Stack : MonoBehaviour
{
    ...
    bool PlaceTile()
    {
        ...
        if (isMovingX)
        {
            ...
            if(Mathf.Abs(deltaX) > ERROR_MARGIN)
            {
                ...
                float middle = lastTilePosition.x + t.position.x / 2f;
        ...
        secondaryPosition = (isMovingX ? lastTilePosition.x : t.localPosition.z);
        isMovingX = !isMovingX;
    ...
    void SpawnTile()
    {
        ...
        stack[stackIndex].transform.localPosition = new Vector3(0f, scoreCount, 0f);

        stack[stackIndex]. transform.localScale = new Vector3(stackBounds.x, 1f, stackBounds.y);
